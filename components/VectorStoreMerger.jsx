          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="space-x-2">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-black bg-blue-500 rounded-md hover:bg-blue-600 disabled:opacity-50"
              >
                Merge Files
              </button>
            </div>
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-black bg-green-500 rounded-md hover:bg-green-600 flex items-center gap-2"
            >
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            <h4 className="text-sm font-medium mb-2 text-black">Statistics</h4>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <p className="text-black">Total Documents</p>
                <p className="font-medium text-black">{mergedDocuments.length}</p>
              </div>
              <div>
                <p className="text-black">Source Files</p>
                <p className="font-medium text-black">{files.length}</p>
              </div>
            </div>
          </div>
        </div>
